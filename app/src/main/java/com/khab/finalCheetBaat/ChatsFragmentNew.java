...
public class ChatsFragmentNew extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainView = inflater.inflate(R.layout.fragment_chats_fragment_new, container, false);

        mConvList = (RecyclerView) mMainView.findViewById(R.id.chatsPage);
        ...
        onlineIcon = (ImageView)mMainView.findViewById(R.id.user_single_online_icon);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(options){
            ...
            public ConvViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(getContext()).inflate(R.layout.users_single_layout, viewGroup, false);
    ...
    public static class ConvViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setMessage(String message, boolean isSeen){
            ...
            if(!isSeen){
                ...
                userStatusView.setTextColor(Color.argb(200, 66, 76,88));
            } else {
